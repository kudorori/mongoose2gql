    ...
    ast.definitions.forEach(function (definition) {
      ...
      if (result[definitionName] == undefined) {
        ...
        result[definitionName] = _ramda2.default.evolve({
          fields: _ramda2.default.pipe(_ramda2.default.concat(_ramda2.default.__, definition.fields))
        }, result[definitionName]);
      }
    });
  });

  return _ramda2.default.pipe(_ramda2.default.map(_ramda2.default.evolve({
    fields: _ramda2.default.uniqBy(_ramda2.default.path(["name", "value"]))
  })), _ramda2.default.toPairs, _ramda2.default.map(_ramda2.default.prop(1)), _ramda2.default.objOf("definitions"), _ramda2.default.assoc("kind", "Document"), _graphql.print)(result);
};