...
exports.mergeType = _mergeType2.default;
...
var createType = function createType(_args) {
  ...
  return _ramda2.default.pipe(_tree2Type2.default, log, (0, _toTypes2.default)(name, description), log, (0, _mergeIgnore2.default)(ignore()), (0, _mergeExtend2.default)(extend()), _toTypeString2.default, log)(schema.tree);
};
