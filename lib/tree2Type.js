...
var arrayToType = _ramda2.default.pipe(_ramda2.default.when(_ramda2.default.has("type"), _ramda2.default.prop("type")), _ramda2.default.head, _ramda2.default.cond([[_ramda2.default.has("type"), function (item) {
