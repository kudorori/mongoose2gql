...
var Field2Type = _ramda2.default.cond([[isInstance(String), resultType("String")], [isInstance(Number), resultType("Float")], [isInstance(_mongoose.Schema.ObjectId), resultType("String")], [isInstance(Array), arrayToType], [isInstance(Object), function (item) {
  return mapType(item);
